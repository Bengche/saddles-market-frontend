...
export default function HeroSection() {
  ...
  return (
    <section ref={ref} className="relative min-h-screen flex items-center overflow-hidden bg-primary-900">
      {/* Parallax background */}
      <motion.div className="absolute inset-0" style={{ y: bgY }}>
        <Image
          src="https://images.unsplash.com/photo-1553284965-5dd67897f9a5?w=1800&q=85"
      ...
      {/* Content */}
      <motion.div className="relative container-custom py-32 pt-44 z-10" style={{ opacity }}>
        <div className="max-w-2xl">
          ...
          >
            ...
            <span className="text-gold-400 text-sm font-medium tracking-widest uppercase">Premium Equestrian</span>
          </motion.div>
          ...
          >
            Discover our curated collection of premium horse saddles — from Western to Dressage, handpicked for quality, comfort, and performance.
          </motion.p>
          ...
          >
            <Link href="/products" className="btn-gold text-base px-8 py-4 shadow-gold">
              <ShoppingBag size={20} />
              Shop Now
            </Link>
            <Link href="/about" className="btn-outline text-white border-white/50 hover:bg-white/10 text-base px-8 py-4">
              <Award size={20} />
              Our Story
            </Link>
          </motion.div>
