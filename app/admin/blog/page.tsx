                    ...
                    >
                      ...
                      <td className="px-5 py-3">
                        <button
                          ...
                          className={`w-9 h-5 rounded-full transition-colors relative ${post.is_published ? "bg-green-500" : "bg-gray-200"}`}
                        >
                          <span
                            className={`absolute top-0.5 w-4 h-4 bg-white rounded-full shadow transition-transform ${post.is_published ? "translate-x-4" : "translate-x-0.5"}`}
                          />
                        </button>
                      </td>
                      <td className="px-5 py-3">
